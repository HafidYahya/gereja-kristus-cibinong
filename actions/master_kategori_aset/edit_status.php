...
if (!$row) {
    header('Location: ../../index.php?page=master_kategori_aset&action=Ubah+status&error=Data+tidak+ditemukan');
    exit();
}
...
$stmt_update->execute();
$stmt_update->close();
header('Location: ../../index.php?page=master_kategori_aset&action=Ubah+status&success=Status+berhasil+diubah');
