...
$sql = "SELECT * FROM users $whereSql ORDER BY u_is_active DESC, id DESC  LIMIT ? OFFSET ?";
...
<div class="p-4">
        ...
        <div class="page-header row g-2 align-items-center">
            ...
            <div class="col-12 col-sm-auto">
                <button type="button"
                    ...
                    data-bs-toggle="modal" data-bs-target="#modal-tambah-user"><i class="fas fa-plus me-2"></i>Tambah
                    Pengguna</button>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="modal-tambah-user" tabindex="-1" aria-hidden="true"
        aria-labelledby="modal-tambah-user-label">
    ...
    <!-- MODAL EDTI -->
    <?php foreach ($users as $user) : ?>
        <div class="modal fade" id="modal-edit-user-<?= $user['id'] ?>" tabindex="-1" aria-hidden="true"
            aria-labelledby="modal-edit-user-label-<?= $user['id'] ?>">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-warning">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3 form-check">
                                <input type="checkbox" class="form-check-input show-password-edit"
                                    id="showPasswordEdit-<?= $user['id'] ?>" data-target="passwordEdit-<?= $user['id'] ?>">
                                <label class="form-check-label" for="showPasswordEdit-<?= $user['id'] ?>">Show
                                    password</label>
                            </div>
                            <div class="mb-3">
